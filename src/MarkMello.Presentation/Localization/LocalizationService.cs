...
public sealed class LocalizationService : ObservableObject, ILocalizationService
{
    private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
    {
        ...
        ["AppMenuAbout"] = "About MarkMello",
        ["AboutWindowTitle"] = "About MarkMello",
        ...
        ["UpdateDefaultMessage"] = "MarkMello doesn't go online at startup.",
    ...
    private static readonly Dictionary<string, string> Russian = new(StringComparer.Ordinal)
    {
        ...
        ["AppMenuAbout"] = "О MarkMello",
        ["AboutWindowTitle"] = "О MarkMello",
        ...
        ["UpdateDefaultMessage"] = "При запуске MarkMello не ходит в сеть.",
